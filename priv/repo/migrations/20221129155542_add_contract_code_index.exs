defmodule FlowContractSyncer.Repo.Migrations.AddContractCodeIndex do
  ...
  def up do
    ...
    execute("CREATE INDEX IF NOT EXISTS contracts_code_trgm_index ON contracts USING GIN (code gin_trgm_ops)")
    execute("CREATE INDEX IF NOT EXISTS contracts_uuid_trgm_index ON contracts USING GIN (uuid gin_trgm_ops)")
  end
