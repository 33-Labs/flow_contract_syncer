defmodule FlowContractSyncer.SnippetCase.TopShot do
  def topshot_functions_without_return(_context) do
    want = [
      """
  ...
  def topshot_functions_with_return(_context) do
    want = [
      """
